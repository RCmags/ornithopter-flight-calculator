...
def chord_ratio(x):					
	return (1 - x**2)**0.5 * (4/(PI*12))
														# deg		glide twist angle at a given dimensionless spanwise position. x=1 is the wingtip
def twist_glide(x):
	return 5
...
area        = 0.52*0.15*2*0.7	# m^2       area of entire wing
# motor properties
throttle    = 1.0	            # %         percent of maximum motor speed
...
motor_rm    = 0.01		        # ohms      resistance of motor
# spring geometry
